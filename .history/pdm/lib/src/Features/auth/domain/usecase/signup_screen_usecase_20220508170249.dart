...
class SignupUseCase {
  ...
  Future<User> signup(String username, String name, String birth,
    ...
    var respValidateAllFields =
        validateAllFields(username, name, birth, password, confirmPassword);
    if (!respValidateAllFields[0]) {
      print(respValidateAllFields[1]);
      throw ErrorDescription(respValidateAllFields[1]);
      // return respValidateAllFields[1];
    } else {
      return repository
