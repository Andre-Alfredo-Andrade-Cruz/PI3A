...
import 'package:pdm/src/Features/home/presentation/view/page/home_page.dart';
...
class LoginScreen extends StatelessWidget {
  ...
  final loginRepository = LoginScreenRepository();
                ...
                Flexible(
                  child: SizedBox(
                      child: ElevatedButton(
                          ...
                          onPressed: () => {
                                loginRepository
                                    .login(User(loginTextFieldController.text,
