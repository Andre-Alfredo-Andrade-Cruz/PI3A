...
// class _SignupScreenState extends ModularState<SignupScreen,SignupScreenViewModular>{
  ...
  final birthTextFieldController = TextEditingController();
  final emailTextFieldController = TextEditingController();
  final passwordTextFieldController = TextEditingController();
  final confirmPasswordTextFieldController = TextEditingController();
  final signupRepository = SignupUseCase();
                    ...
                    Flexible(
                      child: SizedBox(
                          child: ElevatedButton(
                              ...
                              onPressed: () => {
                                    if(signupUseCase.validateName(nameTextFieldController.text)){

                                    }
                                    signupUseCase.validateName(nameTextFieldController.text),
